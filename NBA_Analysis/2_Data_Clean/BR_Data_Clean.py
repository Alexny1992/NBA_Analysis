...
duplicate_drop =df2.drop_duplicates()
print(duplicate_drop)
df3=duplicate_drop.reset_index(drop=True)
print(df3)
# def Player_Totals_Clean():
    # """
    # Cleans player data from 2013-2023 seasons
    ...
    # old_row_num = 0
    # for row_num, ind_year in zip(duplicates_corr, range(2013, 2023)): 
    #     [old_row_num:row_num , 0:1 ] = '{}-{}'.format(ind_year-1,ind_year)
    #     old_row_num = row_num
    ...
    # df2 = df2[df2.Tm != 'TOT']
    # df2 = df2[df2.MP != 0]
    # df2.to_csv('2013-2023-Regular-PlayerStats-edit.csv')
...
#     old_row_num = 0
#     for row_num, ind_year in zip(firstRow_of_each_season[0], range(2013, 2023)): 
